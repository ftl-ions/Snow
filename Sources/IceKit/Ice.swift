...
public class Ice {
    ...
    public static let version = Version(0, 9, 1)
    public static let defaultRoot = Path.home + ".snowbox"
    ...
    public init?(root: Path = Ice.defaultRoot) {
        ...
        do {
            ...
            if let versionString: String = try? versionFile.read().trimmingCharacters(
